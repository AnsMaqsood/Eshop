        ...
        <div className="container">
            <div className="grid md:grid-cols-3 pb-20 pt-5">
                ...
                <div className='py-8 px-4'>
                    ...
                    <p className='text-gray-600dark:text-white/70  lg:pr-24 pt-3 '
                    >Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                        Corporis doloribus
                        ab saepe.
                    </p>
                    <p className='text-gray-500 mt-4 '>By Ans Maqsood</p>
                </div>
                {/* footer links */}
                        ...
                        <ul className='space-y-3'>
                            {
                                FooterLinks.map(
                                    (data, index) => (
                                        <li key={index}>
                                            <a href={data.link} className='text-gray-600 dark:text-gray-400
                               hover:dark:text-white hover:text-black duration-300'>{data.title}</a>
                                        </li>
                                    ))
                            }
                        </ul>
